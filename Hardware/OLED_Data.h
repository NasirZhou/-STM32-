...
extern const uint8_t Battery_1[];    //1格电量
extern const uint8_t Battery_2[];   //2格电量
extern const uint8_t Battery_3[];   //3格电量
extern const uint8_t Battery_4[];  //满电亮
extern const uint8_t Temp_Sign[];
extern const uint8_t News[];
extern const uint8_t Step[];
extern const uint8_t Alarm_Clock[];
extern const uint8_t Brightness[];
extern const uint8_t Light[];
extern const uint8_t Gps[];
extern const uint8_t Heart[];
extern const uint8_t Alarm_Clock_Min[];
